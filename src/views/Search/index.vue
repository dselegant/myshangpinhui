  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="searchParams.categoryName">
              {{ searchParams.categoryName }}<i @click="removeBreadQuery">×</i>
            </li>
            <li class="with-x" v-if="searchParams.keyword">
              {{ searchParams.keyword }}<i @click="removeBreadParams">×</i>
            </li>
            ...
            >
              {{ prop.split(':')[1]
              }}<i @click="removeBreadProps(prop.split(':')[0])">×</i>
            </li>
          </ul>
        </div>
        ...
        <!--selector-->
        <SearchSelector
          :trademarkList="searchData.trademarkList"
          :attrsList="searchData.attrsList"
          @goSearchTradeMark="goSearchTradeMark"
          @goSearchProps="goSearchProps"
        />
        ...
        <div class="details clearfix">
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li
                class="yui3-u-1-5"
                v-for="goods in searchData.goodsList"
                :key="goods.id"
              >
                <div class="list-wrap">
                  <div class="p-img">
...
export default {
  ...
  methods: {
    ...
    // 商标搜索
    goSearchTradeMark(trademark) {
      let { tmName, tmId } = trademark;
    ...
    // 属性搜索
    goSearchProps(attrs, attrValue) {
      let { attrId, attrName } = attrs;
  ...
  computed: {
    ...
    // // 商品总数
    // total() {
    //   return this.searchData.goodsList.length || 0;
    // }
  },
  watch: {
